...
table_server <- function(id, year, attribute, jurisdiction, county, report_type, city_combine) {
  ...
  moduleServer(id, function(input, output, session) { 
    ...
    output$ui_table <- renderUI({
      ...
      display_note <- "Estimates other than Total Population are not yet available for years after 2020."
